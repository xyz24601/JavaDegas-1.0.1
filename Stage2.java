...
public class Stage2
{
  ...
  public Stage2(AllEnemy iallenemy)
  {
    allenemy = iallenemy;
//    level = 1;
  }
    ...
    if (alive)
    {
      if (b1)
      {
                                   ...
                                   level, snd))
        {
          ...
          allenemy.enemy2w2.init(4, Enemy2G2.MIX, 5 + level, 1.0, 0.02);
        }
      ...
      if (b2)
      {
                                    ...
                                    level, snd))
        {
           ...
           *  double ixspeed - horizontal speed                 *
          \*  double iyrspeed - vertical radian speed           */
          allenemy.enemy2w.init(3, Enemy2G.TRIPLE, 1.0, 0.05);
          /*  int imaxwave - max number of waves (groups)       *\
          ...
          \*  double iyrspeed - vertical radian speed           */
          allenemy.enemy3w.init(10, 3.0, 0.5, 0.02);
        }
        return(true);           /* get the hell out of here */
      }
      ...
      if (b5)
      {
        ...
        if (!allenemy.enemy3w.move(ship, efireg, pwrcapg, scores, 50, level,
                                   5, 15, snd))
        {
          b5 = false;
          /*  int imaxwave - max number of waves (groups)       *\
          ...
          allenemy.enemy5w.init(5, 150, 3, 5.0, 5 + level, false, false);
        }
        return(true);
      }
      ...
      if (b6)
      {
        if (!allenemy.enemy5w.move(ship, efireg, pwrcapg, scores, level, snd))
        {
          if (ConfigJD.MUSIC)
          {
  ...
  public void paint(Graphics g)
  {
    if (alive)
    {
      ...
      else if (b6)
      {
        ...
        allenemy.enemy3w.paint(g);
        allenemy.enemy4w.paint(g);
        allenemy.enemy5w.paint(g);
        return;
      }
      else if (b7)
      {
